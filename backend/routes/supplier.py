...
def create_supplier():
    ...
    if not all(k in data for k in ("name", "address", "gst")):
...
def update_supplier(supplier_id):
    ...
    if "last_supplied_date" in data and data["last_supplied_date"]:
        supplier.last_supplied_date = datetime.strptime(
            data["last_supplied_date"], "%Y-%m-%d"
        )
